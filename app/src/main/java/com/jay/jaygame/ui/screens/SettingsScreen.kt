...
private fun SettingsUpgrade(
    ...
    Column(
        ...
        // ── 가족별 강화 카드 ──
        val families = com.jay.jaygame.data.UnitFamily.entries
...
private fun SettingsProfile(
    ...
    val repository = (context.applicationContext as com.jay.jaygame.JayGameApplication).repository
    ...
    Column(
        ...
        GameCard(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                LicenseItem(
                    name = "Orbit MVI",
                    license = "Apache License 2.0",
                    copyright = "Copyright Babylon Health",
                )
                HorizontalDivider(color = Divider)
                LicenseItem(
        ...
        GameCard(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                Text("폰트 라이선스", fontSize = 14.sp, color = Gold, fontWeight = FontWeight.Bold)

                LicenseItem(
                    name = "Noto Sans KR",
                    license = "SIL Open Font License 1.1",
                    copyright = "Copyright Google Fonts",
                )
                HorizontalDivider(color = Divider)
                LicenseItem(
                    name = "MedievalSharp",
                    license = "SIL Open Font License 1.1",
                    copyright = "Copyright wmk69 (Google Fonts)",
                )
            }
        }
