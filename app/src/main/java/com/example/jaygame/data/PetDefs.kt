...
val ALL_PETS: List<PetDef> = listOf(
    ...
    PetDef(1, "독거미", PetGrade.HERO, PetCategory.ATTACK, "맹독 사출", "HP 최대 적에게 DoT 5초", 10f),
    ...
    PetDef(4, "골렘", PetGrade.HERO, PetCategory.SUPPORT, "대지의 방패", "전체 유닛 쉴드 10초", 20f),
    ...
    PetDef(7, "9미호", PetGrade.HERO, PetCategory.UTILITY, "환술", "소환 등급 상향 확률 (패시브)", 0f),
