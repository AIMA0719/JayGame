...
object UnitRegistry {
    ...
    val specs: List<UnitSpec> = buildList {
        ...
        add(UnitSpec(id = 20, name = "화산왕", grade = UnitGrade.MYTHIC, family = "화염",
        ...
        add(UnitSpec(id = 30, name = "태양신 라", grade = UnitGrade.MYTHIC, family = "화염",
        ...
        add(UnitSpec(id = 21, name = "빙하제왕", grade = UnitGrade.MYTHIC, family = "냉기",
        ...
        add(UnitSpec(id = 31, name = "크로노스", grade = UnitGrade.MYTHIC, family = "냉기",
        ...
        add(UnitSpec(id = 22, name = "헤카테", grade = UnitGrade.MYTHIC, family = "독",
        ...
        add(UnitSpec(id = 32, name = "아포칼립스", grade = UnitGrade.MYTHIC, family = "독",
        ...
        add(UnitSpec(id = 23, name = "뇌왕", grade = UnitGrade.MYTHIC, family = "번개",
        ...
        add(UnitSpec(id = 33, name = "제우스", grade = UnitGrade.MYTHIC, family = "번개",
        ...
        add(UnitSpec(id = 24, name = "세라핌", grade = UnitGrade.MYTHIC, family = "보조",
        ...
        add(UnitSpec(id = 34, name = "가이아", grade = UnitGrade.MYTHIC, family = "보조",
