...
/**
 * 필드 시너지 — 같은 가족(Family) 유닛이 필드에 3개 이상이면 해당 가족에 보너스.
 *
 * 3개: 기본 시너지 (약한 보너스)
 * 4개+: 풀 시너지 (강한 보너스 + 특수 효과)
 *
